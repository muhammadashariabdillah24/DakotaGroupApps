...
object ApiConfig {
    ...
    fun getApiService(
        ...
        // Token tidak pernah expired (Opsi B), tidak ada proactive refresh
        ...
        // TokenAuthenticator TIDAK dipasang karena token tidak pernah expired (Opsi B).
        // Jika suatu saat diperlukan kembali, tambahkan:
